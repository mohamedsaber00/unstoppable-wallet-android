# DexBank Wallet Release

This document describes the release process for `DexBank` app.
...
* Compute the sha256 and md5 checksums of the apk file and attach them as separate files, named DexBank-wallet-[version].apk.sha256 and DexBank-wallet-[version].apk.md5 respectively, under the 'Assets' section.

### 10. Make sure DexBank Wallet is 'Reproducible' in [WalletScrutiny](https://walletscrutiny.com/android/io.horizontalsystems.bankwallet/)

* After apk is uploaded to Google Play make sure that new version of DexBank Wallet is 'Reproducible' in WalletScrutiny.